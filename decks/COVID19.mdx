...
<Layout bg='#ffff66'>
  ...
  <FlexContainer>
    <FlexItem padding='1em'>
      <img src={require('../assets/lines.png')} style={{'height':'300px'}}/>
    </FlexItem>
    <FlexItem padding='1em'>
      <img src={require('../assets/pm-icon.png')} style={{'height':'300px'}}/>
    </FlexItem>
  </FlexContainer>
</Layout>
...
<Layout bg='gray'>
  ...
  <img src={require('../assets/pm-icon.png')} style={{'height':'200px'}} />
...
<Layout bg='tomato'>
  <img src={require('../assets/pm-screen.png')}  />
</Layout>
...
<Layout bg='tomato'>
  ...
  <FlexContainer>
    <FlexItem padding='.5em'>
      <span>Step 1</span>
      <img src={require("../assets/new.png")} style={{'height':'200px'}} />
    </FlexItem>
    <FlexItem padding='.5em'>
      <span>Step 2</span>
      <img src={require("../assets/templates.png")} style={{'height':'200px'}} />
    </FlexItem>
    <FlexItem padding='.5em'>
      <span>Step 3</span>
      <img src={require("../assets/search.png")} style={{'height':'200px'}} />
    </FlexItem>
    <FlexItem padding='.5em'>
      <span>Step 4</span>
      <img src={require("../assets/howto.png")} style={{'height':'200px'}} />
    </FlexItem>
  </FlexContainer>
</Layout>
...
<Layout bg='tomato'>
  ...
  <img src={require("../assets/visualizer.png")}/>
</Layout>
...
<Layout bg='tomato'>
  ...
  <img src={require("../assets/template.png")} style={{'width':'60%'}} />
</Layout>
...
<Layout bg='tomato'>
  ...
  <img src={require("../assets/visualize-1.png")} style={{'width':'60%'}} />
</Layout>
...
<Layout bg='tomato'>
  ...
  <img src={require("../assets/pretty.png")} style={{'width':'60%'}} />
</Layout>
...
<img src ={require("../assets/USA Graph.png")}/>
...
<img src ={require("../assets/China.png")}/> 
...
<!-- <img src = {require("../assets/Global Graph.png")}/> -->
...
<img src = {require("../assets/ISO.png")}/>
  
<img src = {require("../assets/russel.png")}/>

<img src = {require("../assets/ISO Code.png")}/>
...
<img src = {require("../assets/China Colors Before.png")}/>
