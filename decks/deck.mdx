...
<Layout bg='#ffff66'>
  ...
  <FlexContainer>
    <FlexItem padding='1em'>
      <img src={lines} style={{'height':'300px'}}/>
    </FlexItem>
    <FlexItem padding='1em'>
      <img src={pm_icon} style={{'height':'300px'}}/>
    </FlexItem>
  </FlexContainer>
</Layout>
...
<Layout bg='gray'>
  ...
  <img src={pm_icon} style={{'height':'200px'}} />
...
<Layout bg='tomato'>
  ...
  <FlexContainer>
    <FlexItem padding='.5em'>
      <span>Step 1</span>
      <img src={new_button} style={{'height':'200px'}} />
    </FlexItem>
    <FlexItem padding='.5em'>
      <span>Step 2</span>
      <img src={templates} style={{'height':'200px'}} />
    </FlexItem>
    <FlexItem padding='.5em'>
      <span>Step 3</span>
      <img src={search} style={{'height':'200px'}} />
    </FlexItem>
    <FlexItem padding='.5em'>
      <span>Step 4</span>
      <img src={howto} style={{'height':'200px'}} />
    </FlexItem>
  </FlexContainer>
</Layout>
...
<Layout bg='tomato'>
  ...
  <img src={template} style={{'width':'60%'}} />
</Layout>
...
<Layout bg='tomato'>
  ...
  <img src={visualize_1} style={{'width':'60%'}} />
</Layout>
